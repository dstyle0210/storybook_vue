...
.a-goodsName{display:-webkit-box;width:100%;overflow:hidden;text-overflow:ellipsis;word-break:break-all;font-size:15px;color:#333;line-height:20px;-webkit-box-orient:vertical;
    ...
    &.-row1{height:20px;-webkit-line-clamp:1;line-clamp:1}
    &.-row2{height:39px;-webkit-line-clamp:2;line-clamp:2}
    &.-row3{height:60px;-webkit-line-clamp:3;line-clamp:3}
    &.-rowauto{display:inline-block}
    .a-goodsName__name{display:inline}
}
</style>